...
import {createOrder as create} from "../http/ordersAPI.js";
...
const CreateOrder = observer(() => {
    ...
    const createOrder = async (values) => {
        ...
        const value = parseFloat(values.value) || 0;
        const deliveryType = values.deliveryType;
        const createOrder = await create(user.user.id, values.from, values.to, length, width, height, weight, value, deliveryType, `${values.passportSerie} ${values.passportNumber}`, deliveryCost);
